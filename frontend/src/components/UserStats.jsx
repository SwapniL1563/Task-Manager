...
const UserStats = () => {
  ...
  return (
    <div className="p-6 w-[85%] md:w-[40%] md:mt-1 mb-4 text-white bg-purple-900 rounded-lg shadow">
      <h1 className="md:text-2xl font-bold mb-6">User Task Statistics</h1>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-purple-600 p-4 rounded shadow">
          <h2 className="text-lg md:text-xl font-semibold mb-2">Total Tasks</h2>
          <p className="text-xl md:text-2xl">{stats.total}</p>
        </div>

        <div className="bg-purple-600 p-4 rounded shadow">
          <h2 className="text-lg md:text-xl font-semibold mb-2">Completed</h2>
          <p className="text-xl md:text-2xl text-green-400">{stats.completed}</p>
          <h2 className="text-lg md:text-xl font-semibold mt-2">Pending</h2>
          <p className="text-xl md:text-2xl text-yellow-400">{stats.pending}</p>
        </div>
